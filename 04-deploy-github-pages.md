...
青の☑️マークがついていたらデプロイに成功しています。赤い❌マークが付いている時は失敗しているので、該当のデプロイをクリックし、ログを開いてエラーを確認しましょう。

（例）Deployを途中でキャンセルしてエラーが出ている
![Cancel](./images/github-cancel.png)

しかし、デプロイの失敗の原因を特定するには慣れや経験が必要なことも多いです。どこか詰まったら周りのできそうな人や講師に確認してみてください。
